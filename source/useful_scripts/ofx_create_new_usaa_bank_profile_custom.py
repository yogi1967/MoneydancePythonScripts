...
# ofx_create_new_usaa_bank_profile_custom.py (build 1) - Author - Stuart Beesley - StuWareSoftSystems 2021
...
# >> this will create a non MD profile to avoid the refresh issues....
...
# build 1 - Initial preview release..... Based upon ofx_create_new_usaa_bank_profile.py
...
""" %(myScriptName, MYPYTHON_DOWNLOAD_URL)
    ...
    ask = MyPopUpDialogBox(ofx_create_new_usaa_bank_profile_frame_, "This script will delete any USAA bank profile(s) it finds and CREATE A BRAND NEW CUSTOM ONE FOR YOU:",
                           ...
                           "This script will correct up to one bank account and one credit card account. You can correct others within Moneydance later\n\n"
