...
EXTN_LIST=("toolbox" "extract_data" "useful_scripts" "list_future_reminders" "net_account_balances" "extension_tester" "my_networth" "total_selected_transactions" "test" "categories_super_window" "net_account_balances2")
RESTRICT_SCRIPT_LIST=("toolbox" "net_account_balances" "net_account_balances2" "total_selected_transactions" "categories_super_window")
